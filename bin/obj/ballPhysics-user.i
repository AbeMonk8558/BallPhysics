...
# 2 "user.c" 2
# 1 "C:/msys64/ucrt64/include/raygui.h" 1 3
# 322 "C:/msys64/ucrt64/include/raygui.h" 3
# 1 "C:/msys64/ucrt64/include/raylib.h" 1 3 4
# 323 "C:/msys64/ucrt64/include/raygui.h" 2 3
# 447 "C:/msys64/ucrt64/include/raygui.h" 3
typedef struct GuiStyleProp {
    unsigned short controlId;
    unsigned short propertyId;
    int propertyValue;
} GuiStyleProp;
# 467 "C:/msys64/ucrt64/include/raygui.h" 3
typedef enum {
    STATE_NORMAL = 0,
    STATE_FOCUSED,
    STATE_PRESSED,
...
# 556 "C:/msys64/ucrt64/include/raygui.h" 3
typedef enum {
    TEXT_SIZE = 16,
    TEXT_SPACING,
    LINE_COLOR,
...
# 579 "C:/msys64/ucrt64/include/raygui.h" 3
typedef enum {
    GROUP_PADDING = 16,
} GuiToggleProperty;
...
# 666 "C:/msys64/ucrt64/include/raygui.h" 3
 void GuiEnable(void);
 void GuiDisable(void);
 void GuiLock(void);
 void GuiUnlock(void);
 _Bool GuiIsLocked(void);
 ...
 char **GuiLoadIcons(const char *fileName, _Bool loadIconsName);
 ...
 int GuiToggle(Rectangle bounds, const char *text, _Bool *active);
 int GuiToggleGroup(Rectangle bounds, const char *text, int *active);
 int GuiToggleSlider(Rectangle bounds, const char *text, int *active);
 int GuiCheckBox(Rectangle bounds, const char *text, _Bool *checked);
 int GuiComboBox(Rectangle bounds, const char *text, int *active);

 int GuiDropdownBox(Rectangle bounds, const char *text, int *active, _Bool editMode);
 int GuiSpinner(Rectangle bounds, const char *text, int *value, int minValue, int maxValue, _Bool editMode);
 int GuiValueBox(Rectangle bounds, const char *text, int *value, int minValue, int maxValue, _Bool editMode);
 int GuiTextBox(Rectangle bounds, char *text, int textSize, _Bool editMode);
 ...
 int GuiTextInputBox(Rectangle bounds, const char *title, const char *message, const char *buttons, char *text, int textMaxSize, _Bool *secretViewActive);
...
# 754 "C:/msys64/ucrt64/include/raygui.h" 3
typedef enum {
    ICON_NONE = 0,
...
# 32 "user.c"
    ...
    {
        DrawLineV(currLnStart, mousePos, 
# 36 "user.c" 3
                                        (Color){ 255, 255, 255, 255 }
# 36 "user.c"
                                             );

...
# 112 "collision.c"
        ...
        for (i = 0; i < 4; i++)
        {
            pos.x = ((pos.x) < (vertices[i].x) ? (pos.x) : (vertices[i].x));
            pos.y = ((pos.y) < (vertices[i].y) ? (pos.y) : (vertices[i].y));
            size.x = ((size.x) > (vertices[i].x) ? (size.x) : (vertices[i].x));
            size.y = ((size.y) > (vertices[i].y) ? (size.y) : (vertices[i].y));
        }
